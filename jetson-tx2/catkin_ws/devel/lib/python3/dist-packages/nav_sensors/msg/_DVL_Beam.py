...
"""autogenerated by genpy from nav_sensors/DVL_Beam.msg. Do not edit."""
import codecs
import sys
...
class DVL_Beam(genpy.Message):
  _md5sum = "420cd38b6b071cd49f2970c3e2cee511"
  _type = "nav_sensors/DVL_Beam"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DVL_Beam, self).__init__(*args, **kwds)
